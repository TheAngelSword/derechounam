...
import { AUTH_PROVIDERS, GROK_PROVIDERS } from "./providers";
...
/** Social providers to render in the sign-in UI. */
export { AUTH_PROVIDERS, GROK_PROVIDERS };

/** Show the Google button only when explicitly enabled for this build. */
...
/** Start a native Better Auth social sign-in. */
export async function signIn(
  ...
  if (result.error) throw new Error(result.error.message ?? "No se pudo iniciar sesión con Google");
}
